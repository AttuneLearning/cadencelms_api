...
## Related: API-ISS-031, `dev_communication/messaging/ui-to-api/2026-02-08_course-content-seed-request.md`
## Blocked-By: API-ISS-031 (API team generating course content seed data)
...
- API-ISS-033: Content endpoint has double-nested response (UI has workaround)
