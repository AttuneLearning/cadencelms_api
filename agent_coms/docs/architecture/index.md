...
This vault records architecture decisions (ADRs) for CadenceLMS. Use the index below to navigate by domain or view the decision log.

- Decision log: [[decision-log]]
- Decisions folder: [[decisions/index]]
- ADR template: [[templates/adr-template]]
