...
Extended memory repository for CadenceLMS API development. This vault stores persistent knowledge that AI agents can reference across sessions.
...
- `#api` - API-related memories
- `#model` - Data model memories
- `#service` - Service layer memories

## Graph View

Open the graph view (Ctrl/Cmd + G) to visualize relationships between memories. Color coding:
- **Blue** - Entities
- **Orange** - Sessions
- **Green** - Patterns
- **Purple** - Context
